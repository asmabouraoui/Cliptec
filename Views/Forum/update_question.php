...
$listeQuestions = $questionC->afficher_questions($user_id);

$id = $_GET['id'];
$Question_row = $questionC->recuperer_question($id);
?>
        ...
        <table>
            <tr>
                <td>
                    ...
                    ?>
                        <form action="update_question_code.php?id=<?php echo $row['question_id']  ?>" method="post" id="add_question_id">
                            <!-- <div>
                      ...
                      <input type="text" name="topic" id="topic">
                            ...
                            <div>
                                ...
                                <select type="text" name="topic" class="form-control" id="topic">
                                    <option value="<?php echo $row['topic']; ?>" selected><?php echo $row['topic']; ?></option>
                                    <?php if (strcmp($row['topic'], "topic 1") != 0) { ?>
                                        <option value="topic 1">topic 1</option>
                                    <?php } ?>

                                    <?php if (strcmp($row['topic'], "topic 2") != 0) { ?>
                                        <option value="topic 2">topic 2</option>
                                    <?php } ?>

                                    <?php if (strcmp($row['topic'], "topic 3") != 0) { ?>
                                        <option value="topic 3">topic 3</option>
                                    <?php } ?>
                                </select>
                            </div>
                            <label>question title</label>
                            <input type="text" value="<?php echo $row['question_title']; ?>" name="questiontitle" id="questiontitle">
    </div>
    <div>
        <label>question content</label>
        <input type="text" name="questioncontent" value="<?php echo $row['question_content']; ?>" id="questioncontent">
    </div>
    <!-- <div>
                      <label>City</label>
