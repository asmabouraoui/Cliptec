...
$client = null;
 ...
 $result = $clientC->getUserInformation($_GET['c']);
 $result2 = $clientC->getUserInformation($_SESSION['CIN']);
 global $user;

 $user = $result->fetch(PDO::FETCH_ASSOC);
 $user2 = $result2->fetch(PDO::FETCH_ASSOC);
...
<script src="https://ajax.aspnetcdn.com/ajax/jquery/jquery-1.9.0.min.js"></script>
    ...
    <pre class="nameuser"><?php echo $user['NAME'];?> <?php echo $user['Lastname'].'\'s profile';?></pre><p><?php echo $user['Role'];?></p><br><hr class="upper">
    ...
    <div class="containerform">
        ...
        <div class="smallcontainer">
            <span class="title"><span class="material-icons-outlined iconform">info</span>Role</span>
            <span class="userdata"><?php echo $user['Role'];?></span>
        </div>
    </div>
    </div>
     ...
     <div id="notification_container" class="notification_container">
            ...
            foreach($Notifications as $Notification)
            {
                ...
                <div class="right_content">
                    ...
                    <button type="submit" class="verify button" onclick=profile("'.$NotClient['CIN'].'")>Verify</button>
                    </div>
                </div>
            </div>';
            }
