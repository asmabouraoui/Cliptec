        ...
        <div class="app-content">
          ...
          <div class="projects-section">
...
</br>  <div class="project-boxes jsGridView">
           ...
           <td> <?php echo $row['adresse'];?></td>
                     ...
                     <td> 
                     <form method="POST" action="./participation/back/supprimer_participation.php">
                                        <button type="submit"  id="supprimer"  class="btn btn-danger">supprimer</button>
                                        <input type="hidden" value=<?PHP echo $row['idp']; ?> name="idp">
                                        </form>
                                        
                      
                                       <a class="btn btn-warning" href="./participation/back/modifier_participation.php?idp=<?PHP echo $row['idp']; ?>">Modifier </a>
...
<td> 
<form method="GET" action="./ajoute.php">
...
?>
        ...
        <div class="project-box-content-header">
                <p class="box-content-header">Card list </p>
                <!-- <p class="box-content-subheader">in case you want to add anything here</p> -->
              </div>
              <table id="example1" class="table table-bordered table-striped">
                  <thead>
           ...
           <td> <?php echo $row['adresse'];?></td>
                     ...
                     <td> 
                     <form method="POST" action="./carte/back/supprimer_carte.php">
                                        <button type="submit"  id="supprimer"  class="btn btn-danger">supprimer</button>
                                        <input type="hidden" value=<?PHP echo $row['idc']; ?> name="idc">
                                        </form>
                                        
                      
                                       <a class="btn btn-warning" href="./carte/back/modifier_carte.php?idc=<?PHP echo $row['idc']; ?>">Modifier </a>
