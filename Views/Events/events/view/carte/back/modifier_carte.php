...
<body id="page-top" background='sarah.jpg'>
                      ...
                      <h1 style="color:#000000">Veuillez choisir vos nouvaux donées</h1>
                           ...
                           <tr> <td>    <p style="color:black;font-size:18px;">identifient :</p> </td>
                               ...
                               <tr> <td> <p style="color:black;font-size:18px;">Nouveau nom :</p> </td>
                                   <td>  <input type="text" class="form-control" style="background-color:black;color:white;width:150px;" name="nom" id="nom" value="<?php echo $user['nom']; ?>"></td>
                               </tr> </div>
                                  
                                <div class="form-group">
                                <tr> <td><p style="color:black;font-size:18px;">Nouveau prenom : </p></td>
                                <td>  <input type="text" style="background-color:black;color:white;width:150px;" class="form-control" name="prenom" id="prenom" value="<?php echo $user['prenom']; ?>"></td>
                                    </tr></div>
                                    <div class="form-group">
                                <tr> <td><p style="color:black;font-size:18px;">Nouvelle date de naissance :</p></td>
                                <td>  <input type="text" style="background-color:black;color:white;width:150px;" class="form-control" name="ddn" id="ddn" value="<?php echo $user['ddn']; ?>"></td>
                                    </tr></div>

                                <div class="form-group">
                                <tr> <td> <p style="color:black;font-size:18px;">Nouvelle adressse : </p></td>
                                <td>   <input type="text" style="background-color:black;color:white;width:150px;"  class="form-control" name="adresse" rows="10" id="adresse" value="<?php echo $user['adresse']; ?>" ></td>
                                </tr> </div>

                                <div class="form-group">
                               <tr> <td><p style="color:black;font-size:18px;">Nouveau telephone : </p></td>
                                <td>  <input type="text" style="background-color:black;color:white;width:150px;" class="form-control" name="tel" id="tel"  value="<?php echo $user['tel']; ?>"></td>
                                </tr>
                                </div>
                               ...
                               <tr> <td colspan="2"> <button type="submit" style="background-color:black;color:white;width:150px;" value="submit" class="btn btn-primary">Submit</button></td> </tr>
