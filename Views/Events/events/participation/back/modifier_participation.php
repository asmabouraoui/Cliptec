...
if (
    ...
    !empty($_POST["tel"])
        ...
        $carteC->modifierparticipation($user, $_GET['idp']);
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                if (isset($_GET['idp'])) {
                    $user = $participationC->recupererparticipation($_GET['idp']);
                ?>
                      ...
                      <h1 style="color:#000000">****************************Veuillez choisir vos nouvaux donées********************************</h1>
                           ...
                           <tr> <td>    <p style="color:black;font-size:18px;">identifient :</p> </td>
                               <br>
                                 ...
                                 <td> <input type="text" style="background-color:purple;color:white;width:150px; " class="form-control" name="id" id="id" value="<?php echo $user['idp']; ?>" readonly></td>
                             </tr> </div>
